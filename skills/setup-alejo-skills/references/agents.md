...
<alejo_repo name="{Project Name}">
  ...
  <canonical_sources>
    <source name="GitHub" purpose="Project code, repo WORKFLOW.md, ADR XML files, and implementation history." />
    <source name="Linear Project Documents" purpose="Alejo setup docs, the WORKFLOW.md mirror, and planning artifacts." />
  ...
  <linear_documents>
    ...
    <document name="WORKFLOW.md" purpose="Mirror of the repo-owned Symphony execution workflow." />
