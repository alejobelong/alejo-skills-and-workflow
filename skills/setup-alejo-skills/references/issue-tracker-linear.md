...
<linear_setup>
  ...
  <symphony_handoff>
    <description>alejo-run reads ready Linear issues, preflights their XML run contract, asks for human approval, then moves approved issues into the Symphony lane.</description>
